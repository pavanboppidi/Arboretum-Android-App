 ...
 *
 */
public class Tower extends Fragment implements GoogleMap.OnMarkerClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().getActionBar().setTitle("Tower trail");
...
//                mMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
    ...
    private void setUpMap() {
        try {
            URL url = new URL("http://csgrad10.nwmissouri.edu/arboretum/towerTrailTrees.php");
...
//                        trailid=gauntTrailTreesContent.getString("trailid");
                        ...
                        Marker marker = mMap.addMarker(new MarkerOptions()
                                .icon(BitmapDescriptorFactory.fromResource(R.drawable.towertrailtreeicon))
