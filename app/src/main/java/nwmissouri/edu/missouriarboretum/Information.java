...
//        isConnected=InternetConnection.isConnected(getActivity());
...
//                        }
                        if (name.equalsIgnoreCase("Information")) {
                            String infoUrl = url.substring(0, url.indexOf("Phone:")-2);
                            String phoneAndEmail = url.substring(url.indexOf("Phone:"));
                            String phone = phoneAndEmail.substring(0, phoneAndEmail.indexOf("Email:")-2);
                            String email = phoneAndEmail.substring(phoneAndEmail.indexOf("Email:"));
