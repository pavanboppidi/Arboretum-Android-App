 ...
 * {@link Chatauqua.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Chatauqua#newInstance} factory method to
 * create an instance of this fragment.
 *
 */
public class Chatauqua extends Fragment implements GoogleMap.OnMarkerClickListener{
     ...
     * @return A new instance of fragment Chatauqua.
     */
    // TODO: Rename and change types and number of parameters
    public static Chatauqua newInstance(String param1, String param2) {
        Chatauqua fragment = new Chatauqua();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().getActionBar().setTitle("Chatauqua trail");
...
//                mMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
    ...
    private void setUpMap() {
        try {
            URL url = new URL("http://csgrad10.nwmissouri.edu/arboretum/chatauquaTrailTrees.php");
...
//                        trailid=gauntTrailTreesContent.getString("trailid");
                        ...
                        Marker marker = mMap.addMarker(new MarkerOptions()
                                .icon(BitmapDescriptorFactory.fromResource(R.drawable.chatauquatrailtreeicon))
